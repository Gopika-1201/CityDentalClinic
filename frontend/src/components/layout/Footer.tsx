  ...
  return (
    <footer className="border-t border-border bg-muted/40">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex flex-col leading-tight">
              ...
              <span className="mt-0.5 text-xs tracking-widest text-muted-foreground uppercase">
            ...
            <ul className="space-y-2.5">
              {siteConfig.hours.map((h) => (
                <li key={h.day} className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">{h.day}</p>
      ...
      <div className="border-t border-border">
        <div className="container-tight flex flex-col items-center justify-between gap-3 py-5 sm:flex-row">
          <div className="flex flex-col items-center gap-1 sm:flex-row sm:gap-3">
            ...
            >
              designed by Web2Hub Technologies
            </a>
          </div>
